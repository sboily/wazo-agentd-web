 ...
 *  @public
 */
XiVOAgentd.prototype.get_agents = function() {
 ...
 *  Logoff an agent
 *
 *  @param number - valid agent number
 *  @public
 */
...
/*
 *  Logoff an agent by ID
 *
 *  @param id - valid id agent
 *  @public
 */
XiVOAgentd.prototype.logoff_agent_by_id = function(id) {
    client = this._connect();
    ...
    client.agents.add('by-id')
                 .add('logoff', { stripTrailingSlash: true });

    return client.agents['by-id'].logoff.create(id);
}
 ...
 *  @public
 */
XiVOAgentd.prototype.login_agent_by_id = function(id, extension, context) {
    client = this._connect();
    ...
    return client.agents['by-id'].login.create(id, agent_login);
}
